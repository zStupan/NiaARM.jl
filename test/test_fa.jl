@testset "Firefly Algorithm Tests" begin
    ...
    @test_throws DomainError fa(sphere, problem, StoppingCriterion(maxiters=1000), popsize=0)
    @test_throws DomainError fa(sphere, problem, StoppingCriterion(maxiters=1000), alpha=-0.1)
    @test_throws DomainError fa(sphere, problem, StoppingCriterion(maxiters=1000), alpha=1.1)
    @test_throws DomainError fa(sphere, problem, StoppingCriterion(maxiters=1000), beta0=-0.1)
    @test_throws DomainError fa(sphere, problem, StoppingCriterion(maxiters=1000), beta0=1.1)
    @test_throws DomainError fa(sphere, problem, StoppingCriterion(maxiters=1000), gamma=-0.1)
    @test_throws DomainError fa(sphere, problem, StoppingCriterion(maxiters=1000), gamma=1.1)
    @test_throws DomainError fa(sphere, problem, StoppingCriterion(maxiters=1000), theta=-0.1)
    @test_throws DomainError fa(sphere, problem, StoppingCriterion(maxiters=1000), theta=1.1)
