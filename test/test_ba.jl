@testset "Bat Algorithm Tests" begin
    ...
    f3 = ba(sphere, problem, StoppingCriterion(acceptable_fitness=0.1, maxevals=20_000), seed=1234)
    ...
    @test f3 ≈ ba(sphere, problem, StoppingCriterion(acceptable_fitness=0.1, maxevals=20_000), seed=1234)
